...
tokens = ['RESERVADO', 'IDENTIFICADOR', 'DELIMITADOR', 'OPERADOR', 'SIMBOLO', 'CORCHETE']

# Patrones para tokens
t_RESERVADO = r'(static|void|arreglo|burbuja |for|lenght|int)'
t_IDENTIFICADOR = r'[a-zA-Z0-9_][a-zA-Z0-9_]*'
t_DELIMITADOR = r'[(){};]'
t_CORCHETE = r'\[\]'
t_OPERADOR = r'[=+<]'
t_SIMBOLO = r'[.,"]'
...
def procesar_resultados():
    ...
    resultados = []
    contador = {'RESERVADO': 0, 'IDENTIFICADOR': 0, 'DELIMITADOR': 0, 'OPERADOR': 0, 'SIMBOLO': 0, 'CORCHETE': 0}
...
def configurar_interfaz():
    ...
    entrada_texto = tk.Text(ventana, font=("Arial", 10), bg="white", fg="black")
    entrada_texto.grid(row=0, column=0, sticky="nsew")
    entrada_texto.configure(insertbackground="blue")

    resultado_texto = tk.Text(ventana, font=("Arial", 10), bg="white", fg="black")
